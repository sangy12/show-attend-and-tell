...
from gen_captions_from_pickle import gen_cap
...
if __name__ == "__main__":
    ...
    for model_idx in range(1,21):
        ...
        solver = CaptioningSolver(model, None, None, n_epochs=60, batch_size=128/2, update_rule='adam',
                              ...
                              model_path='model/small/', test_model='model/small/model-'+str(model_idx),
                                      log_path='log/small/', model_name=model_name)
        ...
        gen_cap(ifname=infile, ofname=ofile)
